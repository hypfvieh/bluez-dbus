...
public interface PhonebookAccess1 extends DBusInterface {
     ...
     */
    TwoTuple<DBusInterface, Map<String, Variant<?>>> PullAll(String _targetfile, Map<String, Variant<?>> _filters) throws BluezInvalidArgumentsException, BluezForbiddenException;
     ...
     * @throws BluezFailedException
     */
    TwoTuple<DBusInterface, Map<String, Variant<?>>> Pull(String _vcard, String _targetfile, Map<String, Variant<?>> _filters) throws BluezInvalidArgumentsException, BluezForbiddenException, BluezFailedException;
